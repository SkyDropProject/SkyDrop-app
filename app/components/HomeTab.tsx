...
const HomeTab = (): ReactElement => {
    ...
    const getPositionDelivery = async (): Promise<void> => {
        ...
        if (positionCoordinates) {
            ...
            const namePosition: string = await getAddressFromCoords(coords.latitude, coords.longitude);
    ...
    return (
        <View style={styles.HomeTab}>
            ...
            <ScrollView horizontal style={styles.ProductsList} contentContainerStyle={{ columnGap: 20 }}>
