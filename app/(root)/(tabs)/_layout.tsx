        ...
        >
            ...
            <Tabs.Screen
                ...
                options={{
                    ...
                    headerShown: false,
                    tabBarIcon: ({ focused }) => (
                        <TabIcon Icon={focused ? HoverSearchIcon : SearchIcon} focused={focused} label="Search" />
                    ),
                }}
            />
            <Tabs.Screen
                ...
                options={{
                    ...
                    headerShown: false,
                    tabBarIcon: ({ focused }) => (
                        <TabIcon Icon={focused ? HoverOrderIcon : OrderIcon } focused={focused} isMain label="Order" />
                    ),
                }}
            />
            <Tabs.Screen
                ...
                options={{
                    ...
                    headerShown: false,
                    tabBarIcon: ({ focused }) => (
                        <TabIcon Icon={focused ? HoverCartIcon : CartIcon} focused={focused} label="Cart" />
                    ),
                }}
            />
            <Tabs.Screen
                ...
                options={{
                    ...
                    headerShown: false,
                    tabBarIcon: ({ focused }) => (
                        <TabIcon Icon={focused ? HoverProfileIcon : ProfileIcon} focused={focused} label="Profile" />
                    ),
                }}
            />
        </Tabs>
